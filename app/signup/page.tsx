...
export default function Page() {
  return (
    <main className="relative overflow-hidden min-h-screen bg-slate-950 px-4 sm:px-6 py-16 text-white">
      ...
      <section className="relative mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <div>
          ...
          <h1 className="max-w-2xl text-4xl font-semibold tracking-tight sm:text-4xl sm:text-5xl lg:text-4xl sm:text-5xl lg:text-6xl">
