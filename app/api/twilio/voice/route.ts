...
<Response>
  <Say voice="Polly.Joanna">Thank you for calling ${xmlEscape(businessName)}. Please leave a message after the tone and we will get back to you as soon as possible.</Say>
  <Record maxLength="120" recordingStatusCallback="${xmlEscape(recordingCallbackUrl)}" recordingStatusCallbackMethod="POST" />
